...
export let createWebSocket = (panelName, listenFor, channelId, onConnected) => {
    ...
    if (process.env.REACT_APP_BUILD_TARGET === "electron") {
        ...
        return new RemoteWebSocket('wss://deusprogrammer.com/api/ws/twitch', panelName, listenFor, channelId, onConnected);
    }
}